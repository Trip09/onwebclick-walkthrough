...
class MovieController extends Controller
{
     ...
     * @Method("GET")
     * @Template("IgniteYourProjectBaseMovieBundle:Admin/Movie:index.html.twig")
     */
    public function indexAction()
    {
        $em = $this->getDoctrine()->getManager();

        $entities = $em->getRepository('IgniteYourProjectBaseMovieBundle:Movie')->findAll();
     ...
     * @Method("POST")
     * @Template("IgniteYourProjectBaseMovieBundle:Admin/Movie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('IgniteYourProjectBaseMovieBundle:Movie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("IgniteYourProjectBaseMovieBundle:Admin/Movie:edit.html.twig")
     */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('admin_movie_'));
    }
